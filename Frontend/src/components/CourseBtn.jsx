...
const CourseBtn = ({ onStartNewLesson }) => {
  ...
  return (
    <div className="flex md:flex-row sm:flex-col lg:flex-row md:space-y-0 space-y-4 md:space-x-4 ">
      <Button onClick={onStartNewLesson} className={`${commonButtonClasses}`}>
